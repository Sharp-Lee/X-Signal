...
TRADE_COLUMNS = (
    ...
    "lot_count",
    "add_count",
    "average_lot_net_realized_return",
    "best_lot_net_realized_return",
    "worst_lot_net_realized_return",
    "holding_bars",
...
def _trade_schema() -> pa.Schema:
    return pa.schema(
        [
            ...
            pa.field("last_entry_open_time", pa.string()),
            pa.field("exit_time", pa.string()),
            pa.field("entry_price", pa.float64()),
            pa.field("average_entry_price", pa.float64()),
            ...
            pa.field("lot_count", pa.int64()),
            pa.field("add_count", pa.int64()),
            pa.field("average_lot_net_realized_return", pa.float64()),
            pa.field("best_lot_net_realized_return", pa.float64()),
            pa.field("worst_lot_net_realized_return", pa.float64()),
